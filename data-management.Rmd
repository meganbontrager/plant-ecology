...
***
### Why use R to manage and analyze ecological data? {.build}
...
- Code is **easily revised**. If you need to change an early step in your analysis pathway, it is generally easy to make the change and re-run the rest of your analyses.  
...
- Each column contains one **variable** of a single format
...
- Datasheet design and data entry are best done in Excel, Google sheets, or equivalent program.
...
- Whenever appropriate, randomize your observations or experimental units. This can be facilitated with random number generators in Excel etc.
